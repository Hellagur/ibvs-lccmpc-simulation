%% Plot initial pose in T-body frame
function Plot_monte_carlo_init_pose(s_ct0_all, r_tc0_all, N)
    ...
    % ---- Sphere (target / terminal set) ----
    sphereColor = [199 212 226]/255;  % sphere
    ...
    % ---- Sphere (chaser / initial set) ----
    % ---- Initial spherical disk (on sphere) ----
    R0 = 20;
